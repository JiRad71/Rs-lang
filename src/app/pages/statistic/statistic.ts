...
class Statistic extends Component {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    this.request.getStatistic().then((data: IUserStat) => {
      ...
      const td2 = new Component(tr1.node, 'td', 'table-column-value', `${res.optional.newWords}`);
      ...
      const td4 = new Component(tr2.node, 'td', 'table-column-value', `${res.optional.rightAnswers}%`);
      ...
      const td6 = new Component(tr3.node, 'td', 'table-column-value', `${res.learnedWords}`);
      ...
      const td8 = new Component(tr4.node, 'td', 'table-column-value', `${res.optional.sprint.newWords}`);
      ...
      const td10 = new Component(tr5.node, 'td', 'table-column-value', `${res.optional.sprint.rightAnswers}%`);
      ...
      const td12 = new Component(tr6.node, 'td', 'table-column-value', `${res.optional.sprint.series}`);
      ...
      const column2 = new Component(row1.node, 'td', 'table-column-value', `${res.optional.audioCall.newWords}`);
      ...
      const column4 = new Component(row2.node, 'td', 'table-column-value', `${res.optional.audioCall.rightAnswers}%`);
      ...
      const column6 = new Component(row3.node, 'td', 'table-column-value', `${res.optional.audioCall.series}`);
