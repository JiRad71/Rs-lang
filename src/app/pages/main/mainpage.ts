...
class MainPage extends Component {
  constructor(parentNode: HTMLElement) {
    ...
    const bgGold = new Component(wrap.node, 'button', '"btn bg_gold', 'Учить слова');
    ...
    // const titleDecoration = new Component(headingWrap.node, 'div', 'title_decoration');
    ...
    const imgItem = new Component(flexItem.node, 'div', 'img_item');
    ...
    const imgItem1 = new Component(flexItem1.node, 'div', 'img_item');
    ...
    const imgItem2 = new Component(flexItem2.node, 'div', 'img_item');
    ...
    const imgDev = new Component(priceItem.node, 'div', 'img_dev');
    ...
    const imgDev1 = new Component(priceItem1.node, 'div', 'img_dev');
    ...
    const imgDev2 = new Component(priceItem2.node, 'div', 'img_dev');
